...
/**
 * 
 * ClientInterfaceImpl3.java (Hangman Client)
 * 
 * Version 1.0
 * 
 */
...
public class ClientInterfaceImpl3 extends UnicastRemoteObject implements ClientInterface  {
	...
	public ClientInterfaceImpl3(String name) throws RemoteException {
		this.name = name;
	...
	public static void main(String[] args) throws NotBoundException, IOException {
		...
		ClientInterfaceImpl3 cii = new ClientInterfaceImpl3(nameOfPlayer);
