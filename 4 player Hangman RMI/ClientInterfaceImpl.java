...
/**
 * 
 * ClientInterfaceImpl.java (Hangman Client)
 * 
 * Version 1.0
 * 
 */
...
public class ClientInterfaceImpl extends UnicastRemoteObject implements ClientInterface {
	...
	public ClientInterfaceImpl(String name) throws RemoteException {
		this.name = name;
	...
	public static void main(String[] args) throws NotBoundException, IOException {
		...
		ClientInterfaceImpl cii = new ClientInterfaceImpl(nameOfPlayer);
