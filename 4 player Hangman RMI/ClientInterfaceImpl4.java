...
/**
 * 
 * ClientInterfaceImpl4.java (Hangman Client)
 * 
 * Version 1.0
 * 
 */
...
public class ClientInterfaceImpl4 extends UnicastRemoteObject implements ClientInterface  {
	...
	public ClientInterfaceImpl4(String name) throws RemoteException {
		this.name = name;
	...
	public static void main(String[] args) throws NotBoundException, IOException {
		...
		ClientInterfaceImpl4 cii = new ClientInterfaceImpl4(nameOfPlayer);
